...
pub fn tr(lang: Lang, key: &str) -> &'static str {
    ...
    let en = |k: &str| -> &'static str {
        match k {
            ...
            "storage.mode" => "Installation mode",
            "storage.automatic" => "Use the entire disk",
            "storage.automatic.desc" => "Let Sirius create the required partitions automatically.",
            "storage.manual" => "Custom partitioning",
            "storage.manual.desc" => "Create, format, label, mount or delete partitions manually.",
            "storage.open_editor" => "Edit Partitions…",
            "storage.editor" => "Custom partitioning",
            "storage.selected_disk" => "Selected disk",
            "storage.layout" => "Disk layout",
            "storage.table" => "Table",
            "storage.close" => "Close",
            "storage.done" => "Done",
            "storage.apply_layout" => "Apply Layout",
    ...
    let pt = |k: &str| -> &'static str {
        match k {
            ...
            "storage.mode" => "Modo de instalação",
            "storage.automatic" => "Usar o disco inteiro",
            "storage.automatic.desc" => "Deixe o Sirius criar automaticamente as partições necessárias.",
            "storage.manual" => "Particionamento personalizado",
            "storage.manual.desc" => "Crie, formate, rotule, monte ou exclua partições manualmente.",
            "storage.open_editor" => "Editar Partições…",
            "storage.editor" => "Particionamento personalizado",
            "storage.selected_disk" => "Disco selecionado",
            "storage.layout" => "Mapa do disco",
            "storage.table" => "Tabela",
            "storage.close" => "Fechar",
            "storage.done" => "Concluído",
            "storage.apply_layout" => "Aplicar Layout",
